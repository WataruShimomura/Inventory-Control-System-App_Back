...
public interface SupplerMapper {
	...
	@Insert("insert into supplers (name, order_reedtime) values (#{suppler_name}, #{order_reedtime})")
	public void entrySupplerReqMapper(@Param("suppler_name") String name,@Param("order_reedtime")int order_reedtime);
